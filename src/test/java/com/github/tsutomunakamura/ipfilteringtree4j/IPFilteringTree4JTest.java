...
import static com.github.tsutomunakamura.ipfilteringtree4j.IPFilteringTree4J.Node;
...
//        }
        ...
        void push_ebfef8cd_643a_4b58_bf3d_a6a761f3ba3c() throws Exception {
            /*
                ...
                +-+-----------------------+                             +-+-----------------------+ +-+-----------------------+
                  ...
                  | Create a glue node        | then update it            |
                +-+-----------------------+ +-+-----------------------+ +-+-----------------------+
                | 192.168.0.0/16(g)       | | 3)192.169.0.0/16(d)     | | 2)172.16.0.0/16(d)      |
                +-------------------------+ +-------------------------+ +-------------------------+
                  |                           |
                +-+-----------------------+ +-+-----------------------+
        ...
        @Test @DisplayName("should be able to push nodes 10.0.0.0/8, 172.16.0.0/16, 192.168.1.0/24, 192.169.0.0/16, 192.168.1.0/24")
        void push_4ae1ffe8_f4c2_4fef_ae7f_ff22c34cd8ef() throws Exception {
             /*
                +-------------------------+
                | 0.0.0.0/0(g)            |
                +-+-----------------------+
        ...
        @Test @DisplayName("should be able to push nodes 10.0.0.0/8, 172.16.0.0/16, 192.168.1.0/24, 192.169.0.0/16, 192.168.1.0/24")
        void push_92341c94_fb82_4e94_ae32_b0667e4e7a52() throws Exception {
              /*
                +-------------------------+
                | 0.0.0.0/0(g)            |
                +-+-----------------------+
